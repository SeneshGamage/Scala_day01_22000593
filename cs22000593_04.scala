...
object cs22000593_04 {
  def main(args:Array[String]){
    def calculateDiscountedPrice(coverPrice: Double, discount: Double): Double = {
...
println(s"The total wholesale cost for $totalUnits copies is Rs. $totalCost")
  }
}